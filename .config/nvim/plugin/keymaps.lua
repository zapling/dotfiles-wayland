...
map('', '<Leader>gJ', '<Cmd>lua vim.diagnostic.goto_next({float = true, severity = vim.diagnostic.severity.ERROR})<CR>', {silent = true})
map('', '<Leader>gk', '<Cmd>lua vim.diagnostic.goto_prev({float = true})<CR>', {silent = true})
map('', '<Leader>gK', '<Cmd>lua vim.diagnostic.goto_prev({float = true, severity = vim.diagnostic.severity.ERROR})<CR>', {silent = true})
